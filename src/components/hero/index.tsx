...
type Props =  {
    //* useRef ile referansı alınana bir elementin tipini tanımlarken RefObject kullanırız
  ...
  return (
    <div className="hero">
        <div className="pt-36 padding-x flex-1 max-h-[920px]">
            <h1 className="hero__title">Özgürlüğü Hiseet, Yolculupa Başla</h1>

            <p className="hero__subtitle">
                Altın standartta hizmetle unutulmaz bir yolculuğa hazır mısın?
                Araç kiralama deneyimini Altın Seçenekleri ile taçlandırarak
